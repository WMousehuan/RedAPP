...
public class AppEventTempBox
{
	...
	public Booster.BoosterType itemTypeUsedRightBefore = Booster.BoosterType.NONE;

	public int lastRewardCount;

	public int lastRewardItemIndex;

	public List<Booster.BoosterType> listUsedBoosterOrder = new List<Booster.BoosterType>();
	...
	public void InitGamePlay()
	{
		...
		listUsedBoosterOrder.Clear();
		totalCollectCount = 0;
		gameContinueCount = 0;
		NumOfItemsAlreadyUsedInLevel = 0;
		itemTypeUsedRightBefore = Booster.BoosterType.NONE;
