...
public class BoardManager : MonoBehaviour
{
	...
	private void GenerateSlots()
	{
		...
		slotGroup.transform.position = CPanelGameUI.Instance.GetBoardPosition();
		//slotGroup.transform.localScale = new Vector3(1.2f, 1.2f,0f);
		int num = 0;
		int num2 = 0;
		for (int i = 0; i < boardData.width; i++)
		{
