...
namespace dotmob
{
	public class DataEncryption
	{
		...
		public static string EncryptString(string toEncrypt)
		{
            ...
            {
                Debug.Log("JuicePopMania DataEncryption.EncryptBytes ex: " + ex.Message);
            }
            return string.Empty;
		}
		...
		public static string DecryptString(string toDecrypt)
		{
			...
			{
                Debug.Log("JuicePopMania DataEncryption.DecryptString ex: " + ex.Message);
            }
            return null;
		}
		...
		public static byte[] DecryptBytes(byte[] toEncryptArray)
		{
			...
			{
                Debug.Log("JuicePopMania DataEncryption.DecryptBytes ex: " + ex.Message);
            }
            return null;
		}
	}
