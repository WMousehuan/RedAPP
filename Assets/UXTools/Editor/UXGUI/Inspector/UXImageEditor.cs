    ...
    public class UXImageEditor : GraphicEditor
    {
        ...
        private void ChangeAvailables()
        {
            ...
            foreach (int i in UXGUIConfig.availableLanguages)
            {
                ...
                Sprite spr = AssetDatabase.LoadAssetAtPath<Sprite>(UXGUIConfig.LocalizationFolder + suf + "/" + actualName + "_" + suf + ".png");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!m_IgnoreLocalization.boolValue)
            {
                ...
                {
                    string path = ThunderFireUITool.Utils.SelectFolder(false);
        ...
        protected new void AppearanceControlsGUI()
        {
            ...
            var type = (UXImage.ColorType)ThunderFireUITool.Utils.EnumPopupLayoutEx(EditorLocalization.GetLocalization("UXImage", "m_ColorType"), typeof(UXImage.ColorType), m_ColorType.intValue, labels);
            ...
            else if (type == UXImage.ColorType.Gradient_Color)
            {
                ...
                var direction = (UXImage.GradientDirection)ThunderFireUITool.Utils.EnumPopupLayoutEx(EditorLocalization.GetLocalization("UXImage", "m_Direction"), typeof(UXImage.GradientDirection), m_Direction.intValue, labels2);
                if (EditorGUI.EndChangeCheck())
                {
        ...
        private void FlipGUI()
        {
            ...
            EditorGUI.BeginChangeCheck();
            m_FlipMode.intValue = ThunderFireUITool.Utils.EnumPopupLayoutEx(m_FlipModeContent.text, typeof(UXImage.FlipMode), m_FlipMode.intValue, labels);
            if (EditorGUI.EndChangeCheck())
            {
            ...
            switch (flipmodeEnum)
            {
                case UXImage.FlipMode.Horziontal:
                    ...
                    if (m_FlipWithCopy.boolValue)
                    {
                        ...
                        m_FlipEdgeHorizontal.intValue = ThunderFireUITool.Utils.EnumPopupLayoutEx(m_FlipEdgeContent.text, typeof(UXImage.FlipEdgeHorizontal), m_FlipEdgeHorizontal.intValue, labels2);
                ...
                case UXImage.FlipMode.Vertical:
                    ...
                    if (m_FlipWithCopy.boolValue)
                    {
                        ...
                        m_FlipEdgeVertical.intValue = ThunderFireUITool.Utils.EnumPopupLayoutEx(m_FlipEdgeContent.text, typeof(UXImage.FlipEdgeVertical), m_FlipEdgeVertical.intValue, labels2);
                ...
                case UXImage.FlipMode.FourCorner:
                    ...
                    m_FlipFillCenter.intValue = ThunderFireUITool.Utils.EnumPopupLayoutEx(m_FlipFillContent.text, typeof(UXImage.FlipFillCenter), m_FlipFillCenter.intValue, labels3);
