...
public class UXUIEditor : Editor
{
    ...
    public static void CreateUXImage(MenuCommand menuCommand)
    {
        ...
        ThunderFireUITool.Utils.InvokeMethod(MenuOptionsType, "AddImage", new object[] { menuCommand });
    ...
    {
        Type MenuOptionsType = typeof(UnityEditor.UI.ImageEditor).Assembly.GetType("UnityEditor.UI.MenuOptions");
        ThunderFireUITool.Utils.InvokeMethod(MenuOptionsType, "AddText", new object[] { menuCommand });
        GameObject obj = Selection.activeGameObject;
        obj.name = "UXText";
    ...
    {
        Type MenuOptionsType = typeof(UnityEditor.UI.ImageEditor).Assembly.GetType("UnityEditor.UI.MenuOptions");
        ThunderFireUITool.Utils.InvokeMethod(MenuOptionsType, "AddToggle", new object[] { menuCommand });
        GameObject obj = Selection.activeGameObject;
        obj.name = "UXToggle";
    ...
    {
        Type MenuOptionsType = typeof(UnityEditor.UI.ImageEditor).Assembly.GetType("UnityEditor.UI.MenuOptions");
        ThunderFireUITool.Utils.InvokeMethod(MenuOptionsType, "AddScrollView", new object[] { menuCommand });
        GameObject obj = Selection.activeGameObject;
