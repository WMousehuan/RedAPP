...
namespace UnityEngine.UI
{
    ...
    public class UXTextEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginChangeCheck();
            var type = ThunderFireUITool.Utils.EnumPopupLayoutEx(EditorLocalization.GetLocalization("UXText", "localizationType"),
            ...
            EditorGUI.BeginChangeCheck();
            var ellipsistype = ThunderFireUITool.Utils.EnumPopupLayoutEx(EditorLocalization.GetLocalization("UXText", "EllipsType"),
