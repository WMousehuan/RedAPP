...
public class LocalizationSettingWindow : EditorWindow
{
    ...
    {
        localizationFolder.text = ThunderFireUITool.Utils.SelectFolder() ?? localizationFolder.text;
    }

    private void SelectRuntimeFile()
    {
        runtimeTablePath.text = ThunderFireUITool.Utils.SelectFile() ?? runtimeTablePath.text;
    }

    private void SelectPreviewFile()
    {
        previewTablePath.text = ThunderFireUITool.Utils.SelectFile() ?? previewTablePath.text;
    }
