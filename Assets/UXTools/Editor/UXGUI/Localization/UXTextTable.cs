...
namespace UnityEngine.UI
{
    ...
    public class UXTextTable
    {
        ...
        public static void CreateRuntimeTable(bool alwaysShowPanel = false)
        {
            ...
            path = ThunderFireUITool.Utils.SaveFile("RuntimeTable", "xlsx");
            if (path == null) return;
        ...
        public static void CreatePreviewTable(bool alwaysShowPanel = false)
        {
            ...
            if (File.Exists(path) && !alwaysShowPanel) return;
            path = ThunderFireUITool.Utils.SaveFile("PreviewTable", "xlsx");
            if (path == null) return;
            FileInfo newFile = new FileInfo(path);
            if (newFile.Exists)
            {
        ...
        [MenuItem(ThunderFireUIToolConfig.Menu_Localization + "/打开静态文本表格 (Open Runtime-Use Text Table)", false, 54)]
        public static void OpenTextTable()
        {
            CreateRuntimeTable();
            Application.OpenURL(Application.dataPath.Replace("Assets", "") + UXGUIConfig.RuntimeTablePath);
        }
        [MenuItem(ThunderFireUIToolConfig.Menu_Localization + "/打开动态文本表格 (Open Preview Text Table)", false, 54)]
        ...
        [MenuItem(ThunderFireUIToolConfig.Menu_Localization + "/将文本表格转为JSON文件 (Convert Text Table to JSON)", false, 54)]
        ...
        [MenuItem(ThunderFireUIToolConfig.Menu_Localization + "/刷新静态文本表格 (Refresh Runtime-Use Text Table)", false, 54)]
